...
def init_client_ws_route(websocket_handler: WebSocketHandler) -> APIRouter:
    """
    Create and return API routes for handling the `/client-ws` WebSocket connections.

    Args:
        websocket_handler: Process-level handler for client WebSocket sessions.
...
def init_webtool_routes(default_context_cache: ServiceContext) -> APIRouter:
    ...
    async def transcribe_audio(file: UploadFile = File(...)):
        ...
        try:
            ...
            logger.info("Transcription completed (text_chars={})", len(text))
            return {"text": text}
    ...
    async def tts_endpoint(websocket: WebSocket):
        ...
        try:
            while True:
                ...
                logger.info("Received text for TTS (text_chars={})", len(text))
                ...
                try:
                    ...
                    for sentence in sentences:
                        ...
                        logger.info(
                            "Generated TTS audio (sentence_chars={})", len(sentence)
                        )
